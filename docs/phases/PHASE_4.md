...
**Status:** IN PROGRESS — P4-3 (all 5 reports), P4-4 (backup/restore/retention), P4-5a, P4-1a/b/c, and P4-2a/b/c/e DONE. Both receipt (P4-1) and invoice (P4-2) are fully built and wired end-to-end in the app, including the "Print Invoice" wholesale-only gating and BUG-A/B/C fixes. P4-0 verified on developer machine (2026-08-29) — shop PC verification still required before go-live. **Waiting on owner's real-hardware results for BUG-A (print mechanism) and BUG-C (customer search) before starting anything further.** P4-1d, P4-2d (real printer output) and P4-5b all need shop PC, cannot be substituted by unit tests.
**Started:** 2026-08-29
**Completed:** —
**Branch:** main
...
| ID      | Task                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Status                                                                                                                                                                                                                                                                                                                                                                  |
| ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| P4-0    | Smoke test — SuppliersPage + PurchasePage on real hardware                                                                                                                                                                                                                                                                                                                                                                                                                              | **PARTIAL — verified on developer machine 2026-08-29; shop PC still required before go-live**                                                                                                                                                                                                                                                                           |
...
| P4-1d   | Real receipt print verification (shop's Windows printer, default A4) — **a physical page out of the printer, not a PDF file in tmp**                                                                                                                                                                                                                                                                                                                                                    | NOT STARTED — needs real hardware                                                                                                                                                                                                                                                                                                                                       |
...
| P4-2d   | Real print of the A4 invoice — **needs owner's hardware.** After completing a sale to a wholesale customer, click "Print Invoice" (shown only when the customer is non-Walk-in and `customerType='wholesale'`), confirm a physical A4 page comes out showing doc number, customer name, at least one line item with UoM, grand total, and balance due.                                                                                                                                  | NOT STARTED — needs real hardware                                                                                                                                                                                                                                                                                                                                       |
...
| P4-5b   | 10x kill/power-cut test on real hardware, `integrity_check` pasted each run                                                                                                                                                                                                                                                                                                                                                                                                             | NOT STARTED — needs real hardware                                                                                                                                                                                                                                                                                                                                       |

---

## 4. Exit criteria

- [ ] P4-0 smoke test passed on the **shop PC** specifically — developer-machine
      verification (2026-08-29) is a pragmatic substitute for code correctness only,
      not hardware compatibility or non-technical user flow; logged in PROJECT.md
- [ ] Receipt prints on the shop's actual Windows printer, default A4 — photo/description pasted
- [ ] A4 invoice PDF opens correctly — doc number, line UoM, totals confirmed
- [ ] R1–R5 each hand-calculated and matched against real report output
- [ ] Backup file restores into a working database on a different directory — row counts match, real files not mocks
- [ ] 10x pull-the-plug test — `PRAGMA integrity_check` returns "ok" every time
- [ ] `npm run verify` exits 0
- [ ] `PROJECT.md`/`PROGRESS.md` updated
...
No longer blocking day-to-day report/backup work: **P4-0 verified on
developer machine (2026-08-29)**, per the owner's explicit pragmatic
substitution — covers code correctness, not hardware compatibility or
non-technical user flow. Shop PC verification, and P4-5b (which cannot
be substituted by unit tests at all), remain required before Phase 4 can
be marked COMPLETE or the shop goes live.
